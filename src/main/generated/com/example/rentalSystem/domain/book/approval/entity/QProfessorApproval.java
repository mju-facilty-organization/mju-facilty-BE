package com.example.rentalSystem.domain.book.approval.entity;
...
public class QProfessorApproval extends EntityPathBase<ProfessorApproval> {
    ...
    private static final long serialVersionUID = -287895379L;
    ...
    public final EnumPath<com.example.rentalSystem.domain.book.rentalhistory.entity.type.RentalApplicationResult> rentalApplicationResult = createEnum("rentalApplicationResult", com.example.rentalSystem.domain.book.rentalhistory.entity.type.RentalApplicationResult.class);
    ...
    public QProfessorApproval(Class<? extends ProfessorApproval> type, PathMetadata metadata, PathInits inits) {
        ...
        this.rentalHistory = inits.isInitialized("rentalHistory") ? new com.example.rentalSystem.domain.book.rentalhistory.entity.QRentalHistory(forProperty("rentalHistory"), inits.get("rentalHistory")) : null;
    }
